...
export default class Addition extends React.Component {
    ...
    getResultDif = () => {
        let resultado = this.state.result - this.state.valueAmount
    ...
    calcPercentualResult = () => {
        ...
        this.state.porcentToAdd < 0 || this.state.porcentToAdd > 100 ?
            ...
            [resultado = ((this.state.valueAmount * (this.state.porcentToAdd / 100)) + this.state.valueAmount),
            ...
            <DismissKeybord>
                <View style={styles.container}>
                    ...
                    <View>
                        {
                            this.state.fontLoaded ?
                                [<Text key={0} style={styles.text}>Taxa de Acrescimo (%)</Text>,
                                <TextInput
                                    key={1}
                                    style={styles.input}
                                    placeholder='15%'
                                ...
                                <View style={styles.modalContainer}>
                                    <TouchableOpacity
                                        ...
                                        <View style={{ textAlign: "center", alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={styles.titleResult}>Acrescimo:</Text>
